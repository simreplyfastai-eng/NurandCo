        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="border border-foreground/20 text-foreground/60 px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium hover:border-primary hover:text-primary transition-all duration-300 w-full sm:w-auto"
            >
              Instagram
            </a>
          </div>
