...
export default function Footer() {
  ...
  return (
    <footer
      style={{
        background: "linear-gradient(160deg, #0e0700 0%, #1A0F00 40%, #261500 100%)",
        color: "#FAF7F2",
        position: "relative",
        overflow: "hidden",
      }}
    >
      ...
      {/* Top amber rule */}
      <div style={{ height: 1, background: "linear-gradient(90deg, transparent, rgba(200,134,10,0.4), transparent)" }} />
      ...
      <div className="container mx-auto px-6 max-w-5xl" style={{ position: "relative", zIndex: 1, paddingTop: 72, paddingBottom: 40 }}>
        ...
        <div className="flex flex-col items-center" style={{ marginBottom: 52 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 20 }}>
            <div style={{ height: 1, width: 40, background: "linear-gradient(90deg, transparent, #C8860A)" }} />
            <span style={{ color: "#C8860A", fontSize: 12 }}>✦</span>
            <div style={{ height: 1, width: 40, background: "linear-gradient(90deg, #C8860A, transparent)" }} />
          </div>
