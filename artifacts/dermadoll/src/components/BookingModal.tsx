  ...
  if (step === "success") {
    ...
    const handleICSDownload = () => {
      ...
      const ics = [
        ...
        "X-WR-CALNAME:Nur & Co Aesthetics",
      ...
      a.href = url; a.download = "nur-and-co-aesthetics-appointment.ics"; a.click();
        ...
        <div style={{ position:"relative", zIndex:1, maxWidth:560, margin:"0 auto", padding:"clamp(32px,5vw,56px) 24px" }}>
          ...
          <div style={{ textAlign:"center", marginBottom:36 }}>
            ...
            <p style={{ fontFamily:"'Inter', sans-serif", fontSize:15, color:"#7a6a50", margin:0 }}>
              Thank you for booking with Nur &amp; Co Aesthetics. We will be in touch shortly to confirm your appointment. ✨
            </p>
          </div>
          ...
          <div style={{ ...glassCard, animation:"ddFadeUp 0.4s ease 0.7s both", marginBottom:24 }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              ...
              <a
                href="https://instagram.com/nurandcoaesthetics" target="_blank" rel="noopener noreferrer"
                className="dd-gbtn"
